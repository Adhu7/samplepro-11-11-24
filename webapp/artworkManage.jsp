                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm" onclick="editArtwork(<%= artwork.getArtId() %>)">Edit</button>
                                <button class="btn btn-danger btn-sm" onclick="deleteArtwork(<%= artwork.getArtId() %>)">Delete</button>
                            </td>
                        </tr>
                        <% } %>
                    </tbody>
